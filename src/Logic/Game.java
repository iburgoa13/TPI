...
public class Game {
	public static final String HELPTEXT = "move <left|right><1|2>: Moves UCM-Ship to the indicated direction.\r\n" + 
 ...
 */
	...
	/**
	 * 
	 * @return devuelve la ayuda al introducir el comando help
	 */
